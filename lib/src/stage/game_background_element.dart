...
class GameBackgroundElement extends Sprite {
  ...
  GameBackgroundElement(GameElement gameElement, TextureAtlas op) {
      ...
      //draw the board
      BitmapData boardData = new BitmapData(_boardSize, _boardSize, true, 0x000000);
      var cr = new Rectangle(0, 0, 112, 122);
      boardData.drawPixels(op.getBitmapData('game_board_corner_top_left'), cr, new Point(0, 0));
      boardData.drawPixels(op.getBitmapData('game_board_corner_top_right'), cr, new Point(_boardSize-112, 0));
      boardData.drawPixels(op.getBitmapData('game_board_corner_bottom_left'), cr, new Point(0, _boardSize-112));
      boardData.drawPixels(op.getBitmapData('game_board_corner_bottom_right'), cr, new Point(_boardSize-112, _boardSize-112));
      ...
      for(var i=0; i<_game.field.width-2; i++) {
        boardData
          ...
          ..drawPixels(op.getBitmapData('game_board_side_bottom'), tbr, new Point(112+i*80, _boardSize-112))
          ..drawPixels(op.getBitmapData('game_board_side_left'), lrr, new Point(0, 112+i*80))
          ..drawPixels(op.getBitmapData('game_board_side_right'), lrr, new Point(_boardSize-112, 112+i*80));
      }

...
class Field extends bot.Array2d<bool> {
  final int bombCount;
  final bot.Array2d<int> _adjacents;
  ...
  factory Field([bombCount = 40, cols = 16, rows = 16, int seed = null]) {
    ...
    return new Field._internal(bombCount, cols,
        new bot.ReadOnlyCollection<bool>(squares));
  }
  ...
  Field._internal(this.bombCount, int cols, bot.ReadOnlyCollection<bool> source) :
    this._adjacents = new bot.Array2d<int>(cols, source.length ~/ cols),
